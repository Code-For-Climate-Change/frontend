...
function AtualizarUsuario() {
    ...
    const checaDataNascimento = user.dataNascimento.length < 2005-6-30
    const checaTipoUsuario = user.tipoUsuario === 'admin' || user.tipoUsuario ==='usuario'
            ...
            <Box paddingX={10}>
                <form onSubmit={onSubmit}>
                    ...
                    <TextField 
                        ...
                        margin="normal" 
                        fullWidth 
                        helperText={checaUsuario ? 'Digite um perfil de usuário válido!' : ''}
                    
                    />
                      <TextField 
                        error={checaDataNascimento} 
                        ...
                        margin="normal" 
                        fullWidth 
                        helperText={checaUsuario ? 'Digite uma data de nascimento válida!' : ''}
